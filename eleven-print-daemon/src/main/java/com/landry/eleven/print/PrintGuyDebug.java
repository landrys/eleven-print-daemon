...
public class PrintGuyDebug {

	Logger logger = LoggerFactory.getLogger(PrintGuyDebug.class);
	...
	public PrintGuyDebug() {
		super();
	}

	public void doPrintWork() throws TooManyPrintJobsException {

		logger.info("Getting print jobs via REST call:" 
		...
		logger.info("Got " + printJobs.length + " to process.");
